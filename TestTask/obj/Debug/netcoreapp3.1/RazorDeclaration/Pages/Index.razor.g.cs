...
#nullable restore
#line 14 "C:\Users\User\Desktop\testovoe\TestTask\TestTask\Pages\Index.razor"
      
    List<Model.Assignment> Assignments = new List<Model.Assignment>();

    protected override void OnInitialized()
    {
        for (int i = 0; i < 3; i++)
        {
            Assignments.Add(new Model.Assignment { Id = Guid.NewGuid(), FinishDate = DateTime.Now, Title = "zadacha", Status = AssignmentStatus.ToDo, Description = "qwedasd wqeqw dasda dwq q" });
        }
    }
