...
#nullable restore
#line 12 "C:\Users\User\Desktop\testovoe\TestTask\TestTask\Shared\Home\AssignmentContainer.razor"
       
    [Parameter]
    public List<Model.Assignment> Assignments { get; set; }

    [Parameter]
    public RenderFragment ChlidContent { get; set; }

    [Parameter]
    public EventCallback<Model.Assignment> OnStatusUpdated { get; set; }

    public Model.Assignment CurrentAssignment { get; set; }
